...
from views import RegistrarUnoPorDiez, UnoPorDiezView, Reporte1x10, Lista1x10Report, Listar1X10,Lista1x10ubchReport, RegistrarUnoPorJefeInst, UnoDiezView, DeleteUnoPorDiez
urlpatterns = patterns('',
                       ...
                       url(r'^unodiez/$', UnoDiezView.as_view(), name='unodiez'),
                       url(r'^eliminar/(?P<pk>\d+)$', DeleteUnoPorDiez.as_view(), name='eliminar_unodiez'),
                       )