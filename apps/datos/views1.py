...
class ListPatrullerosView(ListView):
    ...
    def get_context_data(self, **kwargs):
        ...
        datos_v = datos_i.values('datos__usuario_id','datos__cedula','datos__p_nombre','datos__s_nombre', 'datos__p_apellido', 'datos__s_apellido', 'datos__telefono','datos__cargo' ,'datos__departamento').exclude(datos__grupo_usuario__lt=3).distinct().order_by('datos__cedula')
...
class ReportePatrullerosView(DetailView):
    ...
    def get(self, request, *args, **kwargs):
        ...
        usuario_id = datos.values('usuario_id').distinct()
        datos_i = datos.filter(datos__usuario_id__in=usuario_id)
        datos_v = datos_i.values("datos_id",'datos__cedula','datos__p_nombre','datos__s_nombre', 'datos__p_apellido', 'datos__s_apellido', 'datos__cargo' ,'datos__departamento').exclude(datos__grupo_usuario__lt=3).distinct().order_by('datos__cedula')
